...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("[PropDesignOrchestrator] Cancelling job:", body.jobId);
    ...
    console.log("[PropDesignOrchestrator] Cancel response status:", response.status, "body:", responseText.substring(0, 500));
    ...
    console.error("Error cancelling prop design job:", error);
