...
export default function Studio() {
    ...
    return (
        <div className="flex flex-col items-center justify-center h-screen mt-[90%] sm:mt-[95%] md:mt-96 lg:mt-96 ">
                  ...
                  <div className='description mt-10'>   
                    <div className="logo flex flex-row gap-4">              
                        <Image 
                            ...
                            height={0}
                            sizes ="100vh" 
                            style={{height: '32px', width: '141px', justifyContent: 'center', alignSelf: 'center' }}
              ...
              <div className='flex flex-col md:flex-row lg:flex-row gap-10'>
                ...
                <div className="flex flex-col">
                  ...
                  <div className="logo flex flex-row gap-4 mt-10">   
                    ...
                    <p className="mt-10 mb-10">
                    여러분의 아이디어가 실현이 되는 웬툰 이미지를 만들어 보세요. <br />
