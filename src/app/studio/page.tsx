        ...
        <div className="flex flex-row items-center justify-center h-screen">
            ...
            <div className="flex gap-20">
                  ...
                  <div className=''>                    
                    <Image 
                     ...
                     <Link 
                        ...
                        className='text-xl'
                        >
                        웹소설 스튜디오 <small className='text-[10px]'>BETA</small>
                     ...
                     <div className=''>
                    Your Favorite Story Universe,

                    </div>

                    <p>
                        스토리를 중심으로 원스톱 지원 스토리보드 편집 툴을 지원합니다.
                    </p>
                ...
                <div className="flex flex-col">
                    ...
                    className='text-xl'
                    >
                        이미지 스튜디오  <small className='text-[10px]'>BETA</small>
                    </Link>
