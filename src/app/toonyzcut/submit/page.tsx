            ...
            <div className="flex justify-center w-full px-4">
                <div className="w-full max-w-[600px]">
                    <div className="flex flex-col gap-4 md:my-10 my-0 mb-10">
                        ...
                        <div className="flex flex-row md:justify-end justify-center mt-4 gap-4">
                            <Button
                                variant='outlined'
                                className=' border border-black dark:border-white bg-white dark:bg-white dark:text-black text-black w-[100px] text-sm'
                            >
                                <Link href='/toonyzcut'>
