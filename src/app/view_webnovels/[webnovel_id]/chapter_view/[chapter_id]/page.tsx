...
export const DeleteChapterDialog = ({ language, dictionary, showDeleteModal, setShowDeleteModal, deleteChapterId, handleChapterDelete }: { language: Language, dictionary: Dictionary, showDeleteModal: boolean, setShowDeleteModal: (showDeleteModal: boolean) => void, deleteChapterId: number | null, handleChapterDelete: (chapterId: number) => void }) => {
    return (
