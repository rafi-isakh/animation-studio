...
export default function AuthorProfileCard({ webtoon }: { webtoon: Webtoon }) {
    ...
    return (
        <div className="flex flex-col gap-2 justify-center items-center">
            ...
            color='gray' 
            variant='outlined'
            className='text-black dark:text-black border-2 bg-white border-gray-300 dark:border-gray-600 dark:bg-white rounded-sm px-4 py-2 w-28 flex flex-row justify-center items-center gap-1'>
                {/* +Follow */}
                <Plus size={10} />
