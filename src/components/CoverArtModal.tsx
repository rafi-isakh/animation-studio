        ...
        <Dialog open={showCoverArtModal} onOpenChange={setShowCoverArtModal}>
            <DialogContent className='z-[2500] !gap-0 !p-0 overflow-hidden bg-white dark:bg-[#211F21] border-none shadow-none md:h-auto h-screen !text-md' showCloseButton={true}>
                ...
                <ScrollArea className='w-full h-full p-4'>
                    <DialogDescription className='flex md:flex-row flex-col md:space-x-4 justify-center text-md'>
                        <div className='flex flex-col space-y-4'>
                            <CoverArtPreview coverArt={coverArt} handleCoverArtUploadModal={handleCoverArtUploadModal} />
                            <Button
                                variant='outline'
                                onClick={handleUploadFile}
                                className="border-0 w-[200px] bg-[#DB2777] text-white inline-flex items-center justify-center text-md"
                            >
                        ...
                        <div className='flex flex-col md:py-0 py-2 md:space-y-4 space-y-2 text-md'>
                            <p className={`text-md text-black dark:text-white font-bold break-keep`}>
                                {/* Please upload the cover art for your webnovel. */}
                                {phrase(dictionary, "pleaseUploadTheCoverArt", language)}
                            </p>

                            <p className={`text-md text-gray-500 font-bold break-keep`}>
                                {/* The cover art must be in a 5:3 aspect ratio. */}
                                {phrase(dictionary, "coverArtMustBeInA53AspectRatio", language)}
                            </p>
                            <p className={`text-md text-gray-500 break-keep`}>
                                {/*
                            ...
                            <div className='flex flex-row gap-1 items-center text-md'>
                                ...
                                <p className='text-md text-[#DB2777]'>
