...
export default function NsfwImageGeneratorOrchestrator() {
  const {
    currentStage,
    currentProjectId,
    getStageResult,
  ...
  const handleLoadCsvStoryboard = useCallback(async () => {
    ...
    const startRowIndex = startRowNum - 2;
  ...
  }, [parsedCsvData, csvHeaders, csvStartRow, csvPromptACol, csvPromptBCol, csvPromptCCol, csvBgIdCol, toast, currentProjectId, settings, setStageResult]);
