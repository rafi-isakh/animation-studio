...
export async function savePartClip(
  ...
  await setDoc(getPartClipRef(projectId, partIndex, sceneIndex, clipIndex), {
    ...
    partIndex,
    story: input.story,
    attentionDevice: input.attentionDevice ?? null,
    attentionAction: input.attentionAction ?? null,
    attentionExpression: input.attentionExpression ?? null,
    attentionMood: input.attentionMood ?? null,
    imagePromptA: input.imagePromptA ?? null,
    imagePromptB: input.imagePromptB ?? null,
    imagePromptC: input.imagePromptC ?? null,
    imagePromptD: input.imagePromptD ?? null,
    ...
    backgroundIdA: input.backgroundIdA ?? null,
    backgroundIdB: input.backgroundIdB ?? null,
    backgroundIdC: input.backgroundIdC ?? null,
    backgroundIdD: input.backgroundIdD ?? null,
