...
const OtherTranslateComponent = ({ content, elementId, elementType, elementSubtype, classParams = "", showLoading = true }:
  { content: string, elementId: string, elementType: ElementType, elementSubtype?: ElementSubtype, classParams?: string, showLoading?: boolean }) => {
