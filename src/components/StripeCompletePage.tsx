...
export default function CompletePage() {
  ...
  const STATUS_CONTENT_MAP = {
    succeeded: {
      text: phrase(dictionary, "payment_success", language),
      iconColor: "#30B130",
      icon: SuccessIcon,
    },
    processing: {
      text: phrase(dictionary, "payment_processing", language),
      iconColor: "#6D6E78",
      icon: InfoIcon,
    },
    requires_payment_method: {
      text: phrase(dictionary, "payment_failed", language),
      iconColor: "#DF1B41",
      icon: ErrorIcon,
    },
    default: {
      text: phrase(dictionary, "payment_error", language),
      iconColor: "#DF1B41",
      icon: ErrorIcon,
    }
  };
