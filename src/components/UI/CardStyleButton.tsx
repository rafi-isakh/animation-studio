...
export default function CardStyleButton({
  ...
  return (
    <Button
      variant="outline"
      className={cn(
        "!w-[120px] rounded-full overflow-hidden text-left transition-transform duration-300 ease-out !text-xm",
    ...
    >
      ...
      <p className="text-white text-xm font-medium tracking-wide inline-flex gap-1 items-center">
        <TvMinimalPlay className="w-4 h-4" />
        {loadingVideoGeneration ? phrase(dictionary, "generatingPrompt", language) : title}
      </p>
    </Button>
  )
}
