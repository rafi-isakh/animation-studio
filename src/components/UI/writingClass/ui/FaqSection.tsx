...
export default function FaqSection() {
  ...
  const faqItems: FaqItem[] = [
    ...
    },
    {
      ...
      answer_ko: (
        <>
          투니즈 작법서는 회원가입 후 무료로 다운받으실 수 있습니다. <Link href="/writing-class/downloads" className="text-[#DE2B74] underline">작법서 다운로드 페이지</Link>에서 확인하실 수 있습니다. 화면 상단의 투니즈 작법서 다운로드 버튼을 클릭하시면 됩니다. 책들은 현재 무료이지만 유료 컨텐츠로 전환될 예정입니다.
        </>
      ),
      answer_en: (
        <>
    ...
    },
    {
      ...
      answer_en:
        "Yes, you can submit free-to-publish works to Toonyz. Please contact lisa@stelland.io for more information. You can also check the toonyz.com website for more information.",
    }
  ]
