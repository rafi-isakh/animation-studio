...
주식회사 스텔라앤(이하 '회사')은 서비스의 기획부터 종료까지 「개인정보 보호법」 등 국내 개인정보 보호 관련 법령을 철저히 준수하고 있습니다.

1. 개인정보처리방침의 의의
본 개인정보처리방침은 개인정보보호법을 기준으로 작성되었으며, 이용자의 개인정보 처리 현황을 쉽게 이해할 수 있도록 설명하고자 합니다. 이를 위해 쉬운 용어 사용을 원칙으로 하는 Plain Language Privacy Policy(쉬운 용어를 사용한 개인정보처리방침) 방식을 도입하였습니다.
이 개인정보처리방침은 다음과 같은 의미를 갖습니다.

회사가 수집하는 개인정보의 종류, 이용 방법, 제3자 제공 여부, 그리고 보유 및 파기 절차를 투명하게 공개합니다.
이용자가 자신의 개인정보에 대해 가지는 권리와 이를 행사할 수 있는 절차를 안내합니다.
개인정보 침해 발생 시 대응 방법 및 피해 최소화를 위한 상담·고충처리 방안을 제공합니다.
이용자의 개인정보 자기결정권을 보장하기 위해 회사와 이용자의 권리·의무 관계를 명확히 규정합니다.

2. 수집하는 개인정보
이용자는 회원가입 없이 일부 서비스를 이용할 수 있습니다. 그러나 회사의 모든 서비스를 이용하려면 회원가입이 필요하며, 이에 따라 최소한의 개인정보를 수집합니다.
회원가입 시 수집하는 개인정보:
...
회원 식별 및 관리, 회원 탈퇴 의사 확인 등
맞춤형 서비스 제공 및 신규 서비스 개발
서비스 운영에 지장을 주는 부정행위 방지 및 법적 의무 준수
유료 서비스 제공에 따른 구매 및 결제
이벤트 참여 기회 제공 및 광고성 정보 제공
회사는 수집한 개인정보를 가명 처리하여 통계 작성, 연구, 공익적 기록 보존을 위해 활용할 수 있으며, 이를 위해 필요한 기술적·관리적 조치를 시행합니다.
...
Toonyz는 다음과 같은 내용을 포함하는 작품을 내부 검토 후 통보와 함께 삭제할 수 있습니다:

    1. 저작권 침해 콘텐츠나 민감한 개인정보 포함 내용
    3. 개인 또는 단체 비방 내용
    4. 반사회적이거나 공공질서 위반 내용
    5. 상업적 목적의 콘텐츠나 반복적 문구, 비방, 과도한 욕설 포함 내용
    6. 외부 사이트 유도 내용, 위 내용을 암시하는 제목이 포함
    7. 콘텐츠 저작권을 보호하기 위해 적용된 DRM(Digital Rights Management) 무력화 시도
    8. 기타 불법적이거나 게재에 부적합하다고 판단되는 경우

이 규정을 위반하는 작품에 대한 책임은 작성자에게 있습니다. 
서비스를 통해 얻은 정보의 상업적 이용 및 제3자 제공은 금지되며, 저작권 침해는 관련 법규의 적용을 받습니다.

2. 표지 이용 규정

다음과 같은 표지는 사용이 금지되며, 위반 시 관리자가 수정 또는 삭제할 수 있습니다:

    1. 무단 사용된 저작권 이미지 (상업적 사용 허가 또는 원작자 동의 제외)
    2. 미성년자 부적합 이미지
    3. 비방 또는 불쾌감 유발 이미지
    4. 출처 미표기 이미지
    5. 초상권 침해 이미지
...
외부 이미지 사용 시 작품 소개에 출처를 명시해야 합니다. 
표지와 이미지는 구글/애플 앱스토어 정책에 따라 제재될 수 있으며, 
Toonyz는 관련 법적 문제에 책임지지 않습니다.
`
