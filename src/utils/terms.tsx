...
청소년이 정신적·신체적으로 유해한 환경으로부터 보호받고 건전하게 성장할 수 있도록 노력하며, 안전하게 인터넷을 이용할 수 있는 서비스를 제공하기 위해 청소년보호정책을 명시하고 있습니다.

2. 청소년유해정보에 대한 청소년 보호 장치 및 관리조치
청소년이 아무런 제한장치 없이 유해정보에 노출되지 않도록 청소년유해매체물에 대해서 연령인증장치를 마련,적용하고 있기에 성인 인증장치가 마련된 서비스에 대해서는 이용범위를 제한하게 하는 등 관리를 진행하고 있으며 불법적이거나 청소년에 유해한 키워드에 대한 내용 및 콘텐츠를 지속적으로 관리하고 있습니다.

3. 청소년유해정보로 인한 피해상담 및 고충처리
유해정보로 인한 피해상담 및 고충처리를 위한 전문인력을 배치하여 피해가 확산되지 않도록 하고 있습니다. 하단의 청소년 보호 책임자의 소속 및 성명, 연락처를 참고하시어 피해상담 및 고충처리를 요청하실 수 도 있습니다. 자체적으로 처리가 곤란할 경우 피해 관련기관을 안내해 드리고 있습니다.

4. 유해정보로부터 청소년을 보호하기 위한 교육
청소년보호담당자 및 각 서비스 담당자들을 대상으로 청소년 보호를 위한 각종 관련 법령 및 제재기준, 유해정보 발견 시 대처방법, 위반사항 처리에 대한 보고절차 등을 교육하고 있습니다.

5. 청소년보호책임자 및 담당자의 지정
아래와 같이 청소년보호책임자 및 청소년보호담당자를 지정하여 청소년유해정보의 차단 및 관리, 청소년유해정보로부터의 청소년보호정책을 수립하는 등 건전한 인터넷 환경을 조성하기 위한 제반 활동을 전개합니다.
...
다음 조항을 위반하는 연재 작품은 Toonyz의 내부 심사에 따라서 통지 후 삭제될 수 있습니다.
...
④ 반사회적이고 공공질서를 해치는 내용
⑤ 상업적 이익을 위해 작성된 내용
⑥ 반복적인 구절, 비방, 또는 정상적인 웹 소설로 간주하기 어려운 욕설을 포함하는 내용
⑦ 다른 사이트로 유도하려는 의도가 있는 내용
⑧ 위의 내용을 암시하거나 포함하는 제목
⑨ 콘텐츠 저작권을 보호하기 위해 적용된 DRM(Digital Rights Management)을 무력화하는 경우

위 약관을 위반하는 연재 작품의 모든 책임은 해당 연재 작품의 작성자에게 있습니다.
작성자께서 서비스를 이용하여 얻은 정보를 가공, 판매하는 행위 등 서비스에 게재된 자료를 
영리목적으로 이용하거나 제3자에게 이용하게 할 수 없으며, 게시물에 대한 저작권 침해는 관계법령의 적용을 받습니다.

2. 표지 약관

다음 표지는 사용이 금지됩니다. 이 조건을 위반할 경우 후속 조취에 따라서 관리자가 표지를 변경하거나 삭제할 수 있습니다.

① 다른 사람의 저작권이 있는 표지, 단, 상업적 사용이 가능하거나 원 저작권자의 허가를 받은 경우는 제외
② 18세 미만의 미성년자에게 부적합한 표지
③ 개인이나 단체를 비방하거나 불쾌감 또는 수치를 유발하는 표지
④ 저작권이나 출처를 명확하게 표시하지 않은 표지
⑤ 타인의 초상권을 침해하는 표지
⑥ 공공질서 또는 미풍양속을 저해할 우려가 있는 표지

외부 이미지 사용 시 출처를 반드시 작품소개 란에 기재 해주시길 바랍니다.
...
• 결제 취소는 이메일 문의를 통해 신청할 수 있으며, 결제사 정책에 따라 카드 승인 취소 또는 대금이 고객님의 계좌로 입금되기까지 영업일 기준으로 최대 5일이 소요될 수 있습니다. 
• 환불 신청은 이메일 dami@stelland.io로 신청할 수 있습니다. 이 후 환불에 관한 안내 이메일이 발송됩니다.
