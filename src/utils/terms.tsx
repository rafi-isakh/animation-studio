...
또한, 회사는 수집한 개인정보를 가명 처리하여 통계 작성, 연구, 공익적 기록 보존을 위해 활용할 수 있으며, 이를 위해 필요한 기술적·관리적 조치를 시행합니다.

4. 개인정보의 제공 및 위탁
회사는 이용자의 동의 없이 개인정보를 외부에 제공하지 않습니다. 단, 법령에 의한 요구나 이용자가 제휴사의 서비스를 이용하기 위해 동의한 경우에 한해 제공할 수 있습니다.
또한, 회사는 서비스 제공을 위해 일부 업무를 외부에 위탁하며, 수탁업체가 개인정보를 안전하게 처리하도록 관리·감독합니다.

현재의 수탁업체 및 위탁업무 내용:
AWS: 회원 정보 보관
Stripe: 대금 결제 처리 및 관리

5. 개인정보의 보유 및 파기
회사는 원칙적으로 이용 목적이 달성되면 개인정보를 지체 없이 파기합니다. 다만, 법령에 의해 보존 의무가 있는 경우 해당 기간 동안 안전하게 보관 후 파기합니다.
보존 기간 예시

계약 및 청약 철회 기록: 5년 (전자상거래 등에서의 소비자 보호에 관한 법률)
대금 결제 및 재화 공급 기록: 5년
로그인 기록: 3개월 (통신비밀보호법)

6. 이용자의 권리 및 행사 방법
이용자는 자신의 개인정보를 열람, 수정, 삭제할 권리를 가지며, 회원 탈퇴를 통해 개인정보 수집·이용 동의를 철회할 수 있습니다. 또한, 만 14세 미만 아동의 경우, 법정대리인이 권리를 행사할 수 있습니다.

7. 개인정보 보호를 위한 회사의 노력
회사는 개인정보 보호를 위해 다음과 같은 조치를 시행하고 있습니다.

개인정보 접근 통제 및 권한 제한
암호화를 통한 개인정보의 안전한 저장 및 전송
개인정보보호 교육 및 내부 관리계획 수립

8. 개인정보 보호책임자 및 담당자 안내
회사는 이용자의 개인정보 보호와 관련된 문의를 처리하기 위해 아래와 같이 담당자를 지정하고 있습니다.
개인정보 보호책임자
...
개인정보처리방침의 변경 및 고지
본 개인정보처리방침은 개정 최소 7일 전에 공지사항을 통해 사전 안내되며, 중요한 변경이 발생하는 경우 별도로 안내하고 필요 시 이용자의 동의를 받을 수 있습니다.
공고일자: 2024년 10월 17일
시행일자: 2024년 10월 17일
